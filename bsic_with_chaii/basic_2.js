...
//myArray.push(8); push add the new value at the end of arry
//myArray.pop(); pop remove the last value of the arry
//myArray.unshift(890); unshift add the value in the start of the array
